...
| the whole suite from a clean extraction | run once. 28 of 30 entries PASS; `build_join16` failed on a missing `out/` (fixed here) and `prove_step5` hit a cap that was too tight (1266s typical against 1800s allowed) |
